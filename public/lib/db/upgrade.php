...
function xmldb_main_upgrade($oldversion) {
    ...
    if ($oldversion < 2025082600.02) {

        // Define field deletioninprogress to be added to course.
        $table = new xmldb_table('course');
        $field = new xmldb_field('deletioninprogress', XMLDB_TYPE_INTEGER, '1', null, null, null, '0', 'Deletion of the course is in progress');
        ...
        // Main savepoint reached.
        upgrade_main_savepoint(true, 2025082600.02);
    }
