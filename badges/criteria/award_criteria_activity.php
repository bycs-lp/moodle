...
class award_criteria_activity extends award_criteria {
    ...
    public function get_completed_criteria_sql() {
        ...
        if ($this->method == BADGE_CRITERIA_AGGREGATION_ANY) {
            ...
            // Get all cmids of modules related to the critera.
            $cmids = array_map(fn ($x) => $x['module'], $this->params);
            list($cmcmodulessql, $paramscmc) = $DB->get_in_or_equal($cmids, SQL_PARAMS_NAMED);

            // Create a sql query to get all users who has worked on these course modules.
            ...
            . "cmc.completionstate = :completioncomplete )";
            $paramscmcs = [
            ...
            // Now check each user if the user has as a completion of each module.
