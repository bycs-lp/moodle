...
$string['coursedeletionasynctask'] = 'Delete a course asynchronously';
$string['coursedeletionsettings'] = 'Delete Course';
$string['coursetobedeleted'] = '<b>To be deleted ... {$a}</b>';
...
$string['enablecourseasyncdeletion_help'] = 'Courses are deleted in the background. An adhoc task is triggered for this purpose. During the deletion process, the course is disabled and marked with "To be deleted ...".';
